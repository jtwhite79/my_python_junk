...
def calc_m_para(B,y,Q,g=9.81):
    sigma = calc_sigma(B,y)
    term1 = (4.0/15.0) * sigma * y**(5.0/2.0)
    term2 = 1.5 * Q**2 / (g * sigma * y**(3.0/2.0))
    m = term1 + term2
