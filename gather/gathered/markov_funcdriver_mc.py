...
for draw in range(0,numdraws):
    this_start = np.random.randint(samp_range[0],samp_range[1],1)
...
for d in range(0,numdraws):
    if start_end[d,0] < (np.shape(array)[0]/2):
        ax.plot(np.arange(1,13),trans_draws[d,:-1,0,0],'g-',lw=0.25)
    else:
        ax.plot(np.arange(1,13),trans_draws[d,:-1,0,0],'r-',lw=0.25)
...
for d in range(0,numdraws):
    if start_end[d,0] < (np.shape(array)[0]/2):
        ax.plot(np.arange(1,13),trans_draws[d,:-1,0,1],'g-',lw=0.25)
    else:
        ax.plot(np.arange(1,13),trans_draws[d,:-1,0,1],'r-',lw=0.25)
#ax.bar(np.arange(0.25,12.25),monthly_trans[:-1,0,0],width=0.5,fc='b',alpha=0.5)
...
for d in range(0,numdraws):
    if start_end[d,0] < (np.shape(array)[0]/2):
        ax.plot(np.arange(1,13),trans_draws[d,:-1,1,0],'g-',lw=0.25)
    else:
        ax.plot(np.arange(1,13),trans_draws[d,:-1,1,0],'r-',lw=0.25)
...
for d in range(0,numdraws):
    if start_end[d,0] < (np.shape(array)[0]/2):
        ax.plot(np.arange(1,13),trans_draws[d,:-1,1,1],'g-',lw=0.25)
    else:
        ax.plot(np.arange(1,13),trans_draws[d,:-1,1,1],'r-',lw=0.25)
