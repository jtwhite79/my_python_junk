...
cali_ref_dir = '..\\..\\_model\\bro.02\\flowref\\mod\\'
strt,hk,ss = [],[],[]
ibound,botm = [],[]
...
cali_ds_11 = '..\\..\\_model\\bro.02\\flowref\\swr\\ds_11_19500131.dat'
...
mf.add_external(flow.root+'_swrb.cbc',flow.swr_unit,binflag=True)
