...
dssim_command_omni = 'RunGeostatAlgorithm  dssim::/GeostatParamUtils/XML::<parameters>  '+\
               '<algorithm name="dssim" />     <Grid_Name  value="1000_grid"  />     <Property_Name  value="DsSim" />     '+\
               '<Nb_Realizations  value="'+str(num_realizations)+'" />     <Seed  value="14071789" />     <Kriging_Type  value="Ordinary Kriging (OK)"  />     '+\
               '<Hard_Data  grid="Layer_Thk"   property="Layer_1_thk"  />     <Assign_Hard_Data  value="1"  />     '+\
               '<Max_Conditioning_Data  value="12" />     <Search_Ellipsoid  value="100000 100000 100000  100000 100000 100000" />    '+\
               '<cdf_type  value="Uniform"  />     <LN_mean  value="1" />     <LN_variance  value="1" />     <U_min  value="0.0" />     '+\
               '<U_max  value="30.0" />     <nonParamCdf  ref_on_file ="0"  ref_on_grid ="1"  break_ties ="0" filename =""   grid =""  '+\
               'property ="">  <LTI_type  function ="Power"  extreme ="0"  omega ="3" />  <UTI_type  function ="Power"  extreme ="0"  '+\
               'omega ="0.333" />  </nonParamCdf>    <is_local_correction  value="1"  />     <Variogram  nugget="0" structures_count="1"  >    '+\
               '<structure_1  contribution="20"  type="Exponential"   >      <ranges max="100000"  medium="100000"  min="0"   />      '+\
