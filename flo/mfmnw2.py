...
##        self.cprime = empty( (self.nper,self.mnwmax),dtype='float32' )
        ...
        self.assignarray( self.wellid, wellid )
        self.assignarray( self.nnodes, nnodes )
        self.assignarray( self.losstype, losstype )
        self.assignarray( self.pumploc, pumploc )
        self.assignarray( self.qlimit, qlimit )
        self.assignarray( self.ppflag, ppflag )
        self.assignarray( self.pumpcap, pumpcap )
        self.assignarray( self.rw, rw )
        self.assignarray( self.rskin, rskin )
        self.assignarray( self.kskin, kskin )
        self.assignarray( self.b, b )
        self.assignarray( self.c, c )
        self.assignarray( self.p, p )
        self.assignarray( self.cwc, cwc )
        self.assignarray( self.pp, pp )
##        self.assignarray( self.pumplay_pumprow_pumpcol, pumplay_pumprow_pumpcol )
##        self.assignarray( self.zpump, zpump )
##        self.assignarray( self.hlift, hlift )
##        self.assignarray( self.liftq0, liftq0 )
##        self.assignarray( self.liftqmax, liftqmax )
##        self.assignarray( self.hwtol, hwtol )
        self.assignarray( self.itmp, itmp )
##        self.assignarray( self.capmult, capmult )
##        self.assignarray( self.cprime, cprime )
