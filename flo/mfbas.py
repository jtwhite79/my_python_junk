...
class mfbas(package):
    ...
    def __init__(self, model, ibound=1, strt=1.0, ixsec=False, ichflg=False, hnoflo=-999.99, extension='bas', unitnumber=13):
        ...
        self.__ibound = self.assignarray( self.__ibound, ibound,load=True )       
    ...
    def setibound(self, value):
        print 'resetting ibound to ',value
        self.assignarray(self.__ibound, value)
    ...
    def write_file(self):
        ...
        # IBOUND array
        #print self.ibound
        self.parent.write_array(f_bas, self.ibound, self.unit_number[0], True, 4, -ncol, 'IBOUND Array for Layer',ext_base='ibound')
